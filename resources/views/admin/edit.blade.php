                ...
                <div class="card-body">
                    ...
                    <form class="row g-3" method="post" action="{{ url('admin/update') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="grandfather_name"value='{{$show->grandfathername}}'>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Grand-Mother's Name</label>
                            <input type="text" class="form-control" name="grandmother_name"value='{{$show->grandmothername}}'>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Mobile no.</label>
                            <input type="text" class="form-control" maxlength="10" 
                                name="phone" value='{{$show->phone}}'>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="state"value='{{$show->state}}'>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <img src="{{'../../files/profile_img/'.$show->img}}" alt="Profile" class="rounded-circle">
                            <input type="file" class="form-control" name="img">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Occupation</label>
                            <input type="text" class="form-control" name="occupation" value='{{$show->occupation}}'>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="Jain" name="religion" readonly value='{{$show->religion}}'>
                        </div>
                        <div class="col-md-6">
